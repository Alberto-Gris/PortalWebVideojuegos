...
export const Perfil = () => {
  ...
  const initialIndex = parseInt(
    localStorage.getItem("selectedBackgroundIndex") || "0"
  );
  ...
  const cambiarPerfil = async () => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:8000/update_perfil/", {
        ...
        body: JSON.stringify({
          user_id,
          image_id: (perfilIndex + 1) % perfiles.length,
        }),
      });
      if (!response.ok) {
      ...
      <div className="bg-[#e0e0e0] p-16 rounded-[15px] shadow-lg flex flex-col items-center w-[70vw]">
        ...
        <div className="flex justify-between w-full">
          ...
          <div className="flex flex-col gap-6 w-1/2 items-center">
            ...
            {/* Botón Guardar */}
            <div className="bg-[#6a35ad] text-white px-6 py-2 rounded-md hover:bg-[#4a1c85] transition w-1/4 self-center">
              Guardar
            </div>
          </div>
          ...
          <div className="flex justify-center items-center gap-12 w-1/2">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div
                className="bg-[#6a35ad] text-white px-6 py-2 rounded-md hover:bg-[#4a1c85] transition w-full cursor-pointer"
