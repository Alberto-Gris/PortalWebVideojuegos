// components/FlappyT.tsx
import React from 'react';
import flappy from '../../assets/flappy.mp4'; // Asegúrate de que la ruta sea correcta
...
const FlappyT = () => {
    return (
      <div style={gameContainerStyle}>
        ...
        <h2 style={titleStyle}>Tutorial del juego Flappy</h2>
        <div style={videoContainerStyle}>
          <video 
            style={videoStyle}
            controls
            src={flappy} // Reemplaza con la ruta de tu video
            title="Tutorial del juego Flappy"
          >
            Tu navegador no soporta videos HTML5.
          </video>
        </div>
        <p style={tutorialTextStyle}>
          ¡Bienvenido al tutorial de Flappy! En este video te mostraremos cómo jugar al desafiante juego de vuelo.
        </p>
      </div>
    );
};
