...
import snake from '../../assets/snake.mp4'; // Asegúrate de que la ruta sea correcta
...
const SnakeT = () => {
    return (
      <div style={gameContainerStyle} data-testid='snakeT'>
        ...
        <h2 style={titleStyle}>Tutorial del juego Snake</h2>
        <div style={videoContainerStyle}>
          <video 
            style={videoStyle}
            controls
            src= {snake} // Reemplaza con la ruta de tu video
            title="Tutorial del juego Snake"
          >
            Tu navegador no soporta videos HTML5.
          </video>
        </div>
        <p style={tutorialTextStyle}>
          ¡Bienvenido al tutorial de Snake! En este video te mostraremos cómo jugar al clásico juego de la serpiente.
        </p>
      </div>
    );
  };
