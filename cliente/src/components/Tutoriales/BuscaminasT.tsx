// components/BuscaminasT.tsx
import React from 'react';
import buscaminas from '../../assets/buscaminas.mp4'; // Asegúrate de que la ruta sea correcta
...
const BuscaminasT = () => {
    return (
      <div style={gameContainerStyle}>
        ...
        <h2 style={titleStyle}>Tutorial del juego Buscaminas</h2>
        <div style={videoContainerStyle}>
          <video 
            style={videoStyle}
            controls
            src={buscaminas} // Reemplaza con la ruta de tu video
            title="Tutorial del juego Buscaminas"
          >
            Tu navegador no soporta videos HTML5.
          </video>
        </div>
        <p style={tutorialTextStyle}>
          ¡Bienvenido al tutorial de Buscaminas! En este video te mostraremos cómo jugar al clásico juego de lógica y estrategia.
        </p>
      </div>
    );
};
