// components/TetrixGame.tsx
import React from 'react';
import { Link } from 'react-router-dom';
import tetrix from '../../assets/tetrix.mp4';
...
const TetrixT = () => {
  return (
    <div style={gameContainerStyle}>
      ...
      {/* Título con margen superior aumentado */}
      <h2 style={titleStyle}>Tutorial del juego Tetrix</h2>
      ...
      <div style={videoContainerStyle}>
        <video 
          ...
          controls
          src={tetrix}
          title="Tutorial del juego Tetrix"
        >
          Tu navegador no soporta videos HTML5.
        </video>
      </div>
      <p style={tutorialTextStyle}>
        ¡Bienvenido al tutorial de Tetrix! En este video te mostraremos cómo jugar al clásico juego Tetrix.
      </p>
    </div>
  );
};
